...
** TODO Evolutivo Cif-Checker
*** TODO separar clientes por cada portfolio
*** TODO cada ndg del portfolio es primario, secundario una fila por cada ndg en el resto de carteras
*** TODO cada combinación de ndg primario-ndg secundario va en una pestaña con el nombre del portfolio
** programar subasta martinsa-fadesa para septiembre
